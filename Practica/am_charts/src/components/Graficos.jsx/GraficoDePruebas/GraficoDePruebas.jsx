...
const GraficoDePruebas = () => {
  ...
  return (
    ...
    <div>
      ...
      <div id="chartdiv" ref={chartContainerRef} style={{ width: "98%", height: "500px" }}></div>

      <br /><br /><br /><br />
      <div className="GraficoPruebas">
      {data.map((item, index) => (
        <div key={index}>
          <button className="Boton_Azul" onClick={() => modificarValor2(index)}>{`${item.year}`}</button>
